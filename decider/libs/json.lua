local json={_info="JSON Universal - Kunologist v0.2.3"}
local encode
...
local function decode_error(str, idx, msg)
  ...
  error("[JSON] "..string.format("%s at line %d col %d", msg, line_count, col_count))
end
...
local function codepoint_to_utf8(n)
  ...
  error("[JSON] "..string.format("Invalid unicode codepoint '%x'", n))
end
